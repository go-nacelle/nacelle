...
- Imported `Configurable`, `ConfigurationRegistry`, `WithInitializerContextFilter`, and `WithProcessContextFilter` from [go-nacelle/process](https://github.com/go-nacelle/process). [#11](https://github.com/go-nacelle/nacelle/pull/11)
