...
// 2019-05-16T11:29:11-05:00
// using the command
// $ go-mockgen github.com/go-nacelle/nacelle/config -i Config -o mock_config_test.go -f

package worker

import (
	tags "github.com/go-nacelle/config/tags"
	config "github.com/go-nacelle/nacelle/config"
)

// MockConfig is a mock impelementation of the Config interface (from the
// package github.com/go-nacelle/nacelle/config) used for unit testing.
